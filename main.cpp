...
// prototipul functiei 
void aes_128_encrypt(const uchar plaintext[], const uchar key[16], uchar ciphertext[]);
...
void print_hex_array(const uchar data[], int size)
{
...
int main()
{
    ...
    print_hex_array(ciphertext_mine, 16);
